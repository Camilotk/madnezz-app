...
attributes:{for:document.getElementById("for").value,des:document.getElementById("des").value,pre:document.getElementById("pre").value,men:document.getElementById("men").value,alm:document.getElementById("alm").value,con:document.getElementById("con").value,ref:document.getElementById("ref").value,gua:document.getElementById("gua").value,aur:document.getElementById("aur").value,bio:document.getElementById("bio").value},skills:Array.from(document.querySelectorAll(".skill-row")).map(c=>({name:c.querySelector(".skill-name").value,
value:c.querySelector(".skill-value").value,passiva:c.querySelector("#passiva1").checked,bonus:c.querySelector("#bonus1").checked}))};a=new Blob([JSON.stringify(a,null,2)],{type:"application/json"});a=URL.createObjectURL(a);const b=document.createElement("a");b.href=a;b.download="character-sheet.json";b.click();URL.revokeObjectURL(a)};
