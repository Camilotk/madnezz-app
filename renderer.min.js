...
()=>{var a=document.getElementById("occupationRegistry");a=decodeURIComponent(a.placeholder);navigator.clipboard.writeText(a).then(()=>{alert("Ocupa\u00e7\u00e3o copiado para a \u00e1rea de transfer\u00eancia!")});console.log(a)});document.getElementById("export").addEventListener("click",()=>exportToJSON())});
