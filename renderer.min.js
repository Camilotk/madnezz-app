...
c.faceclaim||"";document.querySelector("#imageLink").value=c.imageLink||"";document.getElementById("imageFrame").src=JSON.parse(d.target.result).imageLink||"https://via.placeholder.com/200x320";window.editor?window.editor.setData(c.history||""):document.querySelector("#history").value=c.history||"";const e=c.attributes||{};document.querySelector("#for").value=e.for||"1";document.querySelector("#des").value=e.des||"1";document.querySelector("#pre").value=e.pre||"1";document.querySelector("#men").value=
e.men||"1";document.querySelector("#alm").value=e.alm||"1";document.querySelector("#con").value=e.con||"1";document.querySelector("#ref").value=e.ref||"1";document.querySelector("#gua").value=e.gua||"1";document.querySelector("#aur").value=e.aur||"1";document.querySelector("#bio").value=e.bio||"1";const k=document.querySelector("#skills-container");k.innerHTML="";Array.isArray(c.skills)&&c.skills.forEach((g,f)=>{const h=document.createElement("div");h.className="skill-row form-group mb-3";h.innerHTML=
`
                ...
                <span class="remove-skill text-danger" style="cursor: pointer;">Remover</span>
            `;k.appendChild(h)})}catch(c){console.error("Erro ao ler o arquivo JSON:",c),alert("Erro ao processar o arquivo JSON.")}};b.readAsText(a);alert("Importado com sucesso")}}document.querySelector("#import").addEventListener("click",function(){console.log("Click");const a=document.querySelector("#importFile");0<a.files.length?importFromJSON(a.files[0]):alert("Nenhum arquivo selecionado para importar.")});
